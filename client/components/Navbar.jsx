...
class Navbar extends Component {
  render() {
    ...
    let isStudent;
    if (Meteor.user().roles && Meteor.user().roles[0] === 'STUDENT') {
      isStudent = true;
    }
      ...
      <div className={classNames("navbar", className)}>
        <div className="navbar__inner">
          <div className="navbar__left-side">
            ...
            <div className="navbar__left-side__item"><NavLink to={"/dashboard"}
                                                              activeClassName="navbar__left-side__item--active">Dashboard</NavLink>
            </div>
